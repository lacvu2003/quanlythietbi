...
<div class="formbold-main-wrapper">
  ...
  <div class="formbold-form-wrapper">
    ...
    <form action="admin/quanly/update/xuly.php" method="POST">
      ...
      <div class="formbold-input-flex">
        <div>
            ...
            autocomplete = "off"
            required
            oninvalid="this.setCustomValidity('Chưa nhập lỗi sản phẩm')" oninput="this.setCustomValidity('')"
            />
        </div>
        ...
        <div>
            ...
            autocomplete = "off"
            required
            oninvalid="this.setCustomValidity('Chưa nhập kết quả sửa')" oninput="this.setCustomValidity('')"
            />
        </div>
      </div>
      ...
      <div class="formbold-mb-3 formbold-input-wrapp">
        <label for="noidungsua" class="formbold-form-label"> Nội dung sửa </label>
          <input
            ...
            autocomplete = "off"
            required
            oninvalid="this.setCustomValidity('Chưa nhập nội dung sửa')" oninput="this.setCustomValidity('')"
          />
      </div>
      ...
      <div class="formbold-input-flex">
        ...
        <div>
            ...
            autocomplete = "off"
            required
            oninvalid="this.setCustomValidity('Chưa nhập người sửa')" oninput="this.setCustomValidity('')"
            />
        </div>
      </div>
      ...
      <div class="formbold-input-flex">
        <div>
            ...
            autocomplete = "off"
            required
            oninvalid="this.setCustomValidity('Chưa nhập giá tiền')" oninput="this.setCustomValidity('')"
            />
        </div>
        ...
        <div>
            ...
            autocomplete = "off"
            required
            oninvalid="this.setCustomValidity('Chưa nhập bảo hành sản phẩm')" oninput="this.setCustomValidity('')"
            />
        </div>
      </div>

      <input type="submit" class="formbold-btn" name="btnThemSua" value="Thêm phiếu sửa">
    </form>
  </div>
</div>
